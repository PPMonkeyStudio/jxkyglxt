...
public class ExcelHead {
	...
	private final static String[] TeacherInfo = { "教职工信息ID", "用户工号", "证件类型", "证件号码", "名族", "国籍", "港澳台", "华侨", "政治面貌",
			"性别", "出生年月", "最高学历", "最高学位", "学缘", "专业技术职称", "职称级别", "学科类别", "参加工作时间", "教师资格证号", "授课类型", "授课状态", "任教专业名称",
			"任教专业代码", "专业任教时间", "是否实验技术人员", "是否双师型", "是否工程背景", "是否行业背景", "行政职务级别", "研究生导师类型", "校内指导博士生人数", "校内指导研究生人数",
			"职工类型", "录用类型", "任职状态", "异动类型", "高校调入", "本校毕业", "本校调整", "校外教师类型", "数据状态", "创建时间" };
	...
	private final static String[] TeacherProject = { "项目ID", "用户ID","项目名称", "项目来源", "成员姓名", "成员工号_排名", "立项编号或批准文号", "项目类别",
			"立项日期", "结题验收或鉴定日期", "经费(万元)", "参与教师数", "级别", "是否重点", "附件地址", "数据状态", "创建时间" };
