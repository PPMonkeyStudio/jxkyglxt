...
<body>
	<div id="left_nav">
		<ul class="left_nav_ul" id="left_nav_ul">
			<li>信息查看</li>
			<li><a href="/teacherms/Page/page_user_info">教职工信息</a></li>
			<li><a href="/teacherms/Page/page_user_award">奖励</a></li>
			<li><a href="/teacherms/Page/page_user_works">著作</a></li>
			<li><a href="/teacherms/Page/page_user_patent">专利</a></li>
			<li><a href="/teacherms/Page/page_user_paper">论文</a></li>
			<li><a href="/teacherms/Page/page_user_project">教师项目(课题)</a></li>
		</ul>
	</div>
	<script>
