...
<jsp:include page="/modal/admin/works_modal.html" flush="true"></jsp:include>
<jsp:include page="/modal/export/works_modal.html" flush="true"></jsp:include>
<jsp:include page="/top_nav.jsp" flush="true"></jsp:include>
<jsp:include page="/user_left_nav.jsp" flush="true"></jsp:include>
</head>
<body>
	<div id="info_type">
		<div id="type_content">著作</div>
				...
				<table class="table" id="user_award_table">
					...
					<tbody>
						...
						<td><img class="checkimg1" data-toggle="modal"
							data-target="#check_works" src="img/查看(3).png" /><img
							class="checkimg2" data-toggle="modal" data-target="#modify_works"
							src="img/修改.png" /><img class="checkimg3" src="img/提交审核.png" /></td>
					</tr>
					 -->
					</tbody>
				</table>
	...
	<script type="text/javascript"
		src="<%=basePath%>/js/works/user_works.js"></script>
