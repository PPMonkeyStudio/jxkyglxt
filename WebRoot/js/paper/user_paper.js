	...
	$.ajax({
		...
		success : function(xhr_data) {
			...
			for(i=0;i<xhr.length;i++){
			    ...
			    if(dataStatus=="10"){
				    str += '<td><input type="hidden" value="' + xhr[i].paperId  + '" ><button class="btn btn-default btn-xs relieveButton" title="修改"><i class="fa fa-pencil-square-o fa-lg"></i></button><button class="btn btn-default btn-xs viewButton" title="提交审核"><i class="fa fa-search-plus fa-lg"  aria-hidden="true"></i></button></td>';		
			    }
			    if(dataStatus=="20"||data.dataState=="30"){
				    str += '<td><input type="hidden" value="' + xhr[i].paperId  + '" ><button class="btn btn-default btn-xs viewButton" title="查看"><i class="fa fa-search-plus fa-lg"  aria-hidden="true"></i></button></td>';		
			    }
			    if(dataStatus=="40"){
