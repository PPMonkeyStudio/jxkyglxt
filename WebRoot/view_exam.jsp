			...
			$('.nav-tabs li a').click(function() {
				...
				switch(a_href) {
					...
					case '#award':
						...
						break;
					case '#works':
						$('#works').load('exam_pageinfo.jsp #works_table_audit');
						break;
					case '#paper':
						$('#paper').load('exam_pageinfo.jsp #paper_table_audit');
						break;
					case '#patent':
						$('#patent').load('exam_pageinfo.jsp #patent_table_audit');
						break;
					case '#project':
						$('#project').load('exam_pageinfo.jsp #project_table_audit');
						break;
					default:
						break;
				}
