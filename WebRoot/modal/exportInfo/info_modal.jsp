					...
					<div class="tab_content">
						<div id="check" class="checkbox">
							<ul class="group-list">
								...
								<!-- <li><label><input id="btn1" type="checkbox">全选</label></li>
								<li><label><input id="btn2" type="checkbox">取消全选</label></li>
								<li><label><input id="btn3" type="checkbox">反选</label></li> -->
							</ul>
							<ul class="group-list">
								...
								<li><button value="1" class="btn btn-info btn-sm">
								...
								<!-- <li><label><input name="checkbox" type="checkbox"
										value="20">授课类型</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="21">授课状态</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="22">校外教师类型</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="23">任教专业名称</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="24">任教专业代码</label></li> -->
							</ul>
							<ul class="group-list">
							...
							<ul class="group-list">
								...
								<li><button value="16" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>学科类别</span>
									</button></li>
								<li><button value="17" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>参加工作时间</span>
									</button></li>
								<li><button value="18" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>入校时间</span>
									</button></li>
								<li><button value="19" class="btn btn-info btn-sm">
							...
							<ul class="group-list">
								...
								<li><button value="22" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>校外教师类型</span>
									</button></li>
								<li><button value="23" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>任教专业名称</span>
									</button></li>
								<li><button value="24" class="btn btn-info btn-sm">
							...
							<ul class="group-list">
								...
								<li><button value="25" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>专业任教时间</span>
									</button></li>
								<li><button value="26" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>是否实验技术人员</span>
									</button></li>
								<li><button value="27" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>是否双师型</span>
									</button></li>
								<li><button value="28" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>是否工程背景</span>
									</button></li>
								<li><button value="29" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>行政职务级别</span>
									</button></li>

								<!-- <li><label><input name="checkbox" type="checkbox"
										value="25">专业任教时间</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="26">是否实验技术人员</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="27">是否双师型</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="28">是否工程背景</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="29">行政职务级别</label></li> -->
							</ul>
							<ul class="group-list">


								<li><button value="30" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>研究生导师类型</span>
									</button></li>
								<li><button value="31" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>是否行业背景</span>
									</button></li>
								<li><button value="32" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>校内指导博士生人数</span>
									</button></li>
								<li><button value="33" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>校内指导硕士生人数</span>
									</button></li>
								<li><button value="34" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>职工类型</span>
									</button></li>

								<!-- <li><label><input name="checkbox" type="checkbox"
										value="30">研究生导师类型</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="31">是否行业背景</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="32">校内指导博士生人数</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="33">校内指导硕士生人数</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="34">职工类型</label></li> -->
							</ul>
							<ul class="group-list">


								<li><button value="35" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>异动类型</span>
									</button></li>
								<li><button value="36" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>任职状态</span>
									</button></li>
								<li><button value="37" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>录用类型</span>
									</button></li>
								<li><button value="38" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>高校调入</span>
									</button></li>
								<li><button value="39" class="btn btn-info btn-sm">
								...
								<!-- <li><label><input name="checkbox" type="checkbox"
										value="35">异动类型</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="36">任职状态</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="37">录用类型</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="38">高校调入</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="39">本校毕业</label></li> -->

							</ul>
							<ul class="group-list">

								<li><button value="40" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>本校调整</span>
									</button></li>
								<li><button value="41" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>校外教师类型</span>
									</button></li>
								<!-- <li><button value="42" class="btn btn-info btn-sm">
										<i class="fa fa-times" aria-hidden="true"></i> <span>数据状态</span>
									</button></li> -->

								<!-- <li><label><input name="checkbox" type="checkbox"
										value="40">本校调整</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="41">校外教师类型</label></li> -->
								<!-- <li><label><input name="checkbox" type="checkbox"
										value="42">数据状态</label></li> -->
