					...
					<div class="tab_content">
						<div id="check" class="checkbox">
							...
							<ul class="group-list">
								...
								<!-- 
								<li><label><input name="checkbox" type="checkbox"
										value="">主编工号_排名</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="">副主编</label></li>
								<li><label><input name="checkbox" type="checkbox"
										value="">副主编工号_排名</label></li>
								<li><label><input type="checkbox" value="">参编</label>
								</li>
								<li><label><input type="checkbox" value="">参编工号_排名</label>
								</li> -->
							</ul>
						</div>
					</div>
